defmodule Warplinks.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: Warplinks.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    WarplinksWeb.Endpoint.config_change(changed, removed)
    :ok
  end
